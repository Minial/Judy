 ...
 * possible operator usage is represented by one bit. FOMs are generated on the
 * fly (based on representation), evaluated, and used for HOM generation and
 * evaluation.
 *
 * @author TM
 */
public class OnTheFlyBestHomProblem extends AbstractBestHomProblem {
	private static final Logger LOGGER = LogManager.getLogger(OnTheFlyBestHomProblem.class);
	 ...
	 */
	public OnTheFlyBestHomProblem(List<IMutationOperator> operators, IMutantEvaluator evaluator,
