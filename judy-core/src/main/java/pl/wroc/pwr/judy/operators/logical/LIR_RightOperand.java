 ...
 * <p/>
 * Replace binary logical instructions with their right operands.
 *
 * @author pmiwaszko
 */
public class LIR_RightOperand extends AbstractCoreMethodMutaionOperator {
	@Override
	public String getDescription() {
		return "replace binary logical instructions with their right operands";
	}
