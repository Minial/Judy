 ...
 * <p/>
 * Replace basic binary arithmetic instructions with their right operands.
 *
 * @author pmiwaszko
 */
public class AIR_RightOperand extends AbstractCoreMethodMutaionOperator {
	@Override
	public String getDescription() {
		return "replace basic binary arithmetic instructions with their right operands";
	}
